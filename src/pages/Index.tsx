  ...
  const technologies = [
    {
      icon: 'Glasses',
      title: 'AR-очки',
      description: 'Специальные очки дополненной реальности для полного погружения',
      features: ['Hands-free управление', 'HD дисплей', 'Комфортная посадка', 'Длительная работа']
    },
    {
      icon: 'Smartphone',
      title: 'AR-камера',
  ...
  const quests = [
    {
      ...
      image: '🏺',
      features: ['Исторические факты', 'Поиск подсказок', 'AR-очки в комплекте']
    },
    {
      ...
      location: 'Планетарий',
      image: '🚀',
      features: ['Научные задачи', 'Логические головоломки', 'AR-очки обязательны']
    },
    {
      ...
      location: 'Библиотека',
      image: '🪄',
      features: ['Творческие задания', 'Групповые испытания', 'AR-очки включены']
    }
  ]
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
              Погрузитесь в мир дополненной реальности с помощью специальных AR-очков. 
              Цифровые элементы сливаются с реальным миром, создавая уникальные приключения 
              и незабываемые впечатления без использования рук
            </p>
